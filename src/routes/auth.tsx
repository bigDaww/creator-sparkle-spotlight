...
export const Route = createFileRoute("/auth")({
  head: () => ({
    meta: [
      { title: "Sign in — Mentioned" },
      { name: "description", content: "Sign in to Mentioned to scan your channel and rank inside AI answers." },
      { property: "og:title", content: "Sign in — Mentioned" },
